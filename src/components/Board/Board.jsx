  ...
  return (
    <>
        ...
        <div className="post-it-note yellow" id="note-1">
          ...
          <h1><br/>
         Ques es l'autisme?</h1>
    
          <p>Share who you want to teach the web to here (ie, friends, family,
          colleagues...)</p>
        </div>
        ...
        <div className="post-it-note red" id="note-2">
          ...
          <p>Share what you want to teach here ie web design w/ Thimble, vide
          editing w/ Popcorn, webpage hacking w/ XRay Goggles...</p>
        </div>
        ...
        <div className="post-it-note blue" id="note-3">
          ...
          <h1><br/>
          Turn it into a party!</h1>
    
          <p>How will you keep things interesting? (ie hands-on participation,
          discussion, live-coding, balloons!)</p>
        </div>
