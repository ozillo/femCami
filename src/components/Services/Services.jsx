    ...
    <section className="services-section">
      ...
      <figure className="figure-servici-home">
      ...
      </div>
        {
          ...
          ?
          <div className="div-muestra-servicis" onClick={()=>{setSeeAllServicis(true)}}>Viu totes els servicis</div>
          :
          <>
          <div className="div-figure-left">
      <figure className="figure-servici-home">
        ...
        />
          <div className="div-figure-info">
            <h2>Logopèdia</h2>
            <p>La Logopèdia és la disciplina que engloba l’estudi, la prevenció, la detecció, l’evaluació, diagnòtic i el tractament dels trastorns de la comunicació humana: les alteracions de la veu, de l’audició, de la parla, del llenguatge (oral, escrit, gestual); i de les funcions orofacilas i deglutòries.
            </p>
          </div>
        </div>
        <img src="https://res.cloudinary.com/dtfugozix/image/upload/v1702076354/Fem%20Cami/Logo/flecha-hacia-abajo-para-navegar_ncfzbc.png" 
      ...
      <figure className="figure-servici-home">
        {
          ...
          <div className="div-figure-info">
            ...
            <p>A Fem Camí duem a terme un reforç escolar personalitzat de les dificultats acadèmiques que es puguin originar durant el curs escolar de l’alumne/a, com també dels continguts que s’hagin d’anar treballant.
            </p>
