...
export const reeducacionPedagogica = [
    {
        mainDescription:
        ...
        content: [
            ...
            },
            {
                ...
                contenido: [
                    `A Fem Camí duem a terme un reforç escolar personalitzat de les dificultats acadèmiques que es puguin originar durant el curs escolar de l’alumne/a, com també dels continguts que s’hagin d’anar treballant.
                Aquest servei el duem a terme dins de les intervencions individuals, en el cas que hi hagi un diagnòstic o dificultats d’aprenentatge, si hi ha la necessitat i la demanda de la família en aquest cas; o com a servei a part, on es dur a terme amb grups reduïts (2-3 alumnes) amb la professional d’educació corresponent, respectant el nivell d’aprenentatge i les edats. Al ser pocs alumnes ens permet continuar atenen l’infant i/o l’adolescent de manera personalitzada.
